...
public class PitchShift {
        ...
        float[] gSynFreq;
        float[] gSynMagn;
        float[] targetPitches = {16.35f, 17.32f,18.35f,19.45f,20.60f,21.83f,23.12f,24.50f,25.96f,27.50f,29.14f,
        						30.87f,32.70f,34.65f,36.71f,38.89f,41.20f,43.65f,46.25f,49.00f,51.91f,55.00f,58.27f,
        						61.74f,65.41f,69.30f,73.42f,77.78f,82.41f,87.31f,92.50f,98.00f,103.83f,110.f,116.54f,
        						123.47f,130.81f,138.59f,146.83f,155.56f,164.81f,174.61f,185.f,195.f,207.65f,220.f,233.08f,
        						246.94f,261.63f,277.18f,293.66f,311.13f,329.63f,349.23f,369.99f,392.f,415.30f,440.f,466.16f,
        						493.88f,523.25f,554.37f,587.33f,622.25f,659.25f,698.46f,739.99f,783.99f,830.61f,880.f,
        						923.33f,987.77f,1046.50f,1108.73f,1174.66f,1244.51f,1318.51f,1396.91f,1479.98f,1567.98f,
        						1661.22f,1760.f,1864.66f,1975.53f,2093.f,2217.46f,2349.32f,2489.02f,2637.02f,2793.83f,
        						2959.96f,3135.96f,3322.44f,3520.f,3729.31f,3951.07f,4186.01f,4434.92f,4698.63f,
        						4978.03f,5274.04f,5587.65f,5919.91f,6271.93f,6644.88f,7040.f,7458.62f,7902.13f};
        String[] possibleKeys = {"C", "C#", "D", "D#", "E", "F", "F#", "G", "G#"};
        float[] CKey = {16.35f, 18.35f,20.6f,21.83f,24.5f,27.50f,30.87f,32.70f,36.71f,41.2f,43.65f,49.f,55.f,61.74f,65.41f,
        				73.42f,82.41f,87.31f,98.0f,110.f,123.47f,130.81f,146.83f,164.81f,174.61f,196.f,220.f,246.94f,261.63f,
        				293.66f,329.63f,349.23f,392.f,440.f,493.88f,523.25f,587.33f,659.26f,698.46f,783.99f,880.f,987.77f,
        				1046.5f,1174.66f,1318.51f,1396.91f,1567.98f,1760.f};
        ...
        /*returns the array of the key you're tuning to
         * invariant: can only be regular notes and sharps; no flats or E#
         */
        public float[] findKey(String key) {
        	int start = 0;
        	int notenum = 0;
        	int index = 0;
        	float[] keyPitches = new float[(7 * targetPitches.length)/12];
        	for (int i = 0, len = possibleKeys.length; i < len; i++){
        		if (key == possibleKeys[i]){
        			start = i;
        		}
        	}
        	for (int j = start, len2 = targetPitches.length; j < len2; j++){
        		if (notenum%7 == 2 || notenum%7 == 6){
        			keyPitches[index] = targetPitches[j];
        			//System.out.println("" + j);
        			//System.out.println("" + keyPitches[index]);
        			index++;
        			notenum++;
        		}
        		else {
